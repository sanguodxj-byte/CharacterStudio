        ...
        public static FaceChannelProfileSet BuildEyeDefaults(PawnEyeDirectionConfig.EyeMotionConfig m)
        {
            ...
            set.profiles = new[]
            {
                ...
                Profile("NeutralSoft", 6,
                    ...
                    scaleXBase: m.scaleXBase,
                    scaleXWave: m.scaleXWaveAmplitude,
                    scaleZBase: m.neutralSoftScaleZ),
                Profile("NeutralLookDown", 6,
                    ...
                    scaleXBase: m.scaleXBase,
                    scaleXWave: m.scaleXWaveAmplitude,
                    scaleZBase: m.neutralLookDownScaleZ),
                ...
                Profile("ShockWide", 3,
                    ...
                    scaleXBase: m.scaleXBase,
                    scaleXWave: m.scaleXWaveAmplitude,
                    scaleZBase: m.shockWideScaleZ,
                    scaleZWave: m.shockWideScaleZWave),
                Profile("ScaredWide", 3,
                    ...
                    scaleXBase: m.scaleXBase,
                    scaleXWave: m.scaleXWaveAmplitude,
                    scaleZBase: m.scaredWideScaleZ,
                    scaleZWave: m.scaredWideScaleZWave),
                Profile("ScaredFlinch", 3,
                    ...
                    scaleXBase: m.scaleXBase,
                    scaleXWave: m.scaleXWaveAmplitude,
                    scaleZBase: m.scaredFlinchScaleZ),
                Profile("Hidden", 0),
            };
            return set;
        }
