...
#pragma warning restore CS0618
                ...
                visibleExpressions = this.visibleExpressions != null ? (string[])this.visibleExpressions.Clone() : Array.Empty<string>(),
                hiddenExpressions = this.hiddenExpressions != null ? (string[])this.hiddenExpressions.Clone() : Array.Empty<string>(),
