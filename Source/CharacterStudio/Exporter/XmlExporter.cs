    ...
    public static class XmlExporter
    {
        ...
        private static XElement CreatePawnRenderNodeDefElement(PawnSkinDef skinDef, PawnLayerConfig layer, int index)
        {
            ...
            return new XElement("PawnRenderNodeDef",
                ...
                layer.useWestOffset ? new XElement("useWestOffset", "true") : null,
                layer.offsetWest != Vector3.zero ? new XElement("offsetWest", ToVec3(layer.offsetWest)) : null,
                new XElement("drawOrder", layer.drawOrder),
                new XElement("scale", ToVec2(layer.scale)),
                layer.scaleEastMultiplier != Vector2.one ? new XElement("scaleEastMultiplier", ToVec2(layer.scaleEastMultiplier)) : null,
                layer.scaleNorthMultiplier != Vector2.one ? new XElement("scaleNorthMultiplier", ToVec2(layer.scaleNorthMultiplier)) : null,
                layer.scaleWestMultiplier != Vector2.one ? new XElement("scaleWestMultiplier", ToVec2(layer.scaleWestMultiplier)) : null,
